...
const emit = defineEmits(['close', 'color-added']);
...
const handleSubmit = async () => {
  try {
    ...
    await apiService.post(`/ref-data/colors`, {
      id: colorId.value,
...
<template>
  <div class="absolute bg-pink-700 shadow-lg p-6 h-full w-full z-50">
    ...
    <h2 class="text-xl font-bold text-white mb-4 text-center">Add Color</h2>
    <form @submit.prevent="handleSubmit">
      <div class="mb-4">
        <label for="colorId" class="block text-white">Color id</label>
        <input
            type="text"
            id="colorId"
            v-model="colorId"
      ...
      <div class="mb-4">
        <label for="classNameEn" class="block text-white">Color name (En)</label>
        <input
            type="text"
            id="classNameEn"
            v-model="colorNameEn"
      ...
      <div class="mb-4">
        <label for="classNameAr" class="block text-white">Color name (Ar)</label>
        <input
            type="text"
            id="classNameAr"
            v-model="colorNameAr"
