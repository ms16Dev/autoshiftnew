...
import { ref } from 'vue';
import PopupMenu from './FABMenu.vue'; // Import the pop-up menu component
...
const toggleMenu = () => {
  if(showMenu.value){
    ...
    currentIcon.value = ["fas","fa-close"]
    currentText.value = "Close"
  }
...
<template>
  <div class="relative inline-block">
    ...
    >
      <i :class="[currentIcon, 'text-2xl text-center w-8 h-8']" />
      <span class="hidden xl:block font-extrabold">{{ currentText }}</span>
    </button>
