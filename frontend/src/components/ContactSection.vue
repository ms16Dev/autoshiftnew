<template>
  <div class="pattern-bg relative w-full h-auto mx-auto flex flex-col md:flex-row bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden shadow-lg mb-24">
